...
static void dump_cpu_alive_mask(struct msm_watchdog_data *wdog_dd)
{
	...
	// TODO: Hardronix, find a replacement for cpulist_scnprintf!!!!!!!
	printk(KERN_INFO "Unable to dump CPU alive mask for now, as it's unimplemented due to Hardronix failing to find a replacement...\n");
}
